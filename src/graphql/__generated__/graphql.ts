...
export type AddUserGamesMutation = {
  __typename?: "Mutation";
  addUserGames?: {
    __typename?: "AddUserGamesPayload";
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "bannerPicture" },
                },
                { kind: "Field", name: { kind: "Name", value: "userPicture" } },
              ],
            },
          },
        ],
...
export const AddUserGamesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddUserGames" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  AddUserGamesMutation,
  AddUserGamesMutationVariables
>;
